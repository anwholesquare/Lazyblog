...
<head>
    ...
    <!-- Custom styles for this template -->
    <link href="<?= base_url('dashboardui/dashboard.css') ?>" rel="stylesheet">
</head>
...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark"
        ...
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Lazyblog</a>

        <ul class="navbar-nav flex-row d-md-none">

            <li class="nav-item text-nowrap" id="mobileMenu">
    ...
    <div class="container-fluid">
        <div class="row">
            <div id="navigation" class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary mt-5">
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2"
                                    href="<?= base_url('dashboard/create') ?>">
                                    <svg class="bi">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control mt-2" id="tags" name="tags" required>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control mt-2" id="seo_title" name="seo_title">
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <textarea class="form-control mt-2" id="seo_short_description" name="seo_short_description"
                                rows="3"></textarea>
                        </div>
                        <div class="form-group mt-3">
                            <label for="robot_type">Robot Type</label>
                            <input type="text" class="form-control mt-2" id="robot_type" name="robot_type">
                        </div>

                        <button type="submit" class="btn btn-primary mt-3" style="width:100%">Publish</button>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        toggleButton.addEventListener("click", () => {
            // Toggle the z-index value between 1 and 2
            zIndex = zIndex === -1 ? 1000 : -1;
            elementToToggle.style.zIndex = zIndex;
        });
